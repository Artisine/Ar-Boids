...
import {mainPlayer, hellfireEnabled, mouse, changeMouseCursorIfMouseOverBoid} from "./../client.js";
import WeaponsPlatform from "./weaponsPlatform.js";
...
export class UserInputService {
	...
	static whenMouseClick(e) {
		...
		if (hellfireEnabled) WeaponsPlatform.hellfire();
	}
